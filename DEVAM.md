...
| **Testler** | **589 test** (578 SQLite yeşil + 11 gerçek Neon PG; `dotnet test`) + canlı eşitleme QA **7/7** |
...
| **Masaüstü** | **1.0.90 YAYINDA** — 1.0.89'un tümü + çıkış hızı (2sn) + şube/kullanıcı veri kaybı düzeltmesi (çevrimiçi sunucu-otoriteli create). Güncelleme: makine yalnız EN SON tam paketi indirir/kurar. |
