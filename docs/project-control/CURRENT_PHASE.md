...
| Sonraki TEK iş | **PK-CR-09 kararı** (v1 Custom Rapor veri kaynağı kümesi: A=mevcut 3 SearchGrid · B=yeni kaynaklar eklenerek · C=yalnız kişiselleştirme) → sonra FAZ 3/S2 uygulama. Ekip+Hiyerarşi+Onay ⏸️; N/Mobil ⏭️ ATLANDI |
