...
| Yayın bekleyen işler | ⏳ **7b — BAKIM-EKİPMAN GENİŞLETMESİ** (kod tamam, **commit YOK**, **YAYINLANMADI**). Yayın kapsamı: **canlı şema 85 → 86** (Migration086_EquipmentMaintenance) · API + Web dağıtım · masaüstü yeni sürüm. Commit ve yayın **ayrı açık onay** bekliyor |
...
| Son commit | `d589d3f` (ARA İŞ 5 — push edildi, yayınlandı) · **7b için commit YOK** (çalışma ağacında) |
| Son başarılı test | Tam süit **3.196/0/48** · **7b grupları 24/24** · izole PG **56/56** · Debug + Release + test build **0 hata** (7b, 2026-08-30) |
| Bekleyen ana karar | **YOK** — FIN-B1/Migration082 ✅ kapandı, ARA İŞ 5 kararları (ADR-187/188) ✅ kesinleşti |
| Sonraki TEK iş | **Kullanıcının commit onayı** → ardından 7b yayını (şema 85 → 86, API+Web dağıtım, masaüstü yeni sürüm). Kod ve testler **tamam**; commit/push ve yayın **ayrı açık onay** bekliyor. N/Mobil ⏭️ ATLANDI |
