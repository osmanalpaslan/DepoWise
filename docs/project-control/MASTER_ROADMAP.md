...
|---|---|---|---|
| **FAZ C** | **Depo bazlı stok** (`STK-00…08`, `TRF-01`) | **Projenin 1 numaralı mimari borcu**; ön muhasebe ve şantiye maliyeti buna bağlı. **KARAR-7=A ile açıldı** | 🔵 **AKTİF** — `STK-00…05` ✅ |
...
| `STK-06` | Rapor + Dashboard lokasyon boyutu (Stok Durumu + Stok Sayım) | 🟡 **PLAN TAMAM, KOD BAŞLAMADI** |
