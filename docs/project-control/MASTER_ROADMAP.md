...
| **ARA İŞ 3** | — | Tarih dönüşüm hataları (tarih kayması) — S1d bulgusunun ayrı ara işi | Kullanıcı talebi (2026-08-29) | 🟢 **FAZ 3 + YAYIN ÖNCESİ DOĞRULAMA TAMAM · ⛔ YAYIN ONAYI BEKLİYOR** (rapor: `ARA_IS_3_01_YAYIN_ONCESI.md`; commit `ab0d0d4`; tam süit 3026/0, izole PG 52/52, 3 Release 0 hata) — kararlar ADR-184 (PK-TAR-01=A · 02=A · 03=A · 04=A · 05=A · 06=B · 07=A); 20 tarih yazım noktası tek kaynağa bağlandı (`IsGunuTarihi`), web `Stock.razor` düzeltildi · **MIGRATION YOK, canlı şema 81 kalır** · production'a dokunulmadı — [ARA_IS_3_00_ANALIZ.md](ARA_IS_3_00_ANALIZ.md). Yeniden sayım: **11 ekran / 19 masaüstü noktası + web'de 1 gerçek hata** (`Stock.razor:258`); web'in kalan 10 noktası DOĞRU. Bekleyen: **PK-TAR-01…07**. ⚠️ **Bu ara iş ana roadmap'i DEĞİŞTİRMEZ**; yayınlandıktan sonra dönülecek nokta: **AŞAMA 3 — FIN-B1/Migration082 ayrı onay süreci**. |
