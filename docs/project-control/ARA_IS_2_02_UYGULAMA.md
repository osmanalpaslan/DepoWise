...
> **YAYIN 1: 2026-08-29 · BAŞARILI.** Commit `386b22d` · masaüstü **1.0.161** · API + Web dağıtıldı ·
> **hiçbir migration uygulanmadı, canlı şema 81'de kaldı** · yayın sonrası kontroller **28/28**.
>
> ⭐ **YAYIN 2 (DÜZELTME — ADR-183): kullanıcı canlıda iki hata bildirdi, düzeltilip yeniden yayınlandı.**
> (1) **Araç Raporu — Günlük** verisi olmayan satırları listeliyordu (1.972 satırın çoğu boş) → artık
