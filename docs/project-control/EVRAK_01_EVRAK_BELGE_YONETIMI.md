...
⛔ **Yayınlanmadı** (kullanıcı talimatı: GELİŞTİR → TEST → RAPORLA → ONAYLA → YAYINLA). Yayın turunda:
deploy öncesi/sonrası canlı salt-okunur sayım (file_records adet/kind dağılımı dahil) alınacak;
Migration073+074 deploy ile koşacak.
