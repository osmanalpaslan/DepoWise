...
static object ReportCatalogItem(DepoWise.Application.Reports.ReportDescriptor d) => new
{
    ...
    usesSort = d.UsesSort,   // 2026-09-02: siralama (sabit liste, ReportSortOptions)
...
record ReportReqDto(long? FromDate, long? ToDate, List<string>? BranchIds, List<string>? VehicleIds, string? CompanyId, List<string>? VehicleTypeIds, List<string>? MaintenanceDefIds, List<string>? TechnicianIds, List<string>? SupplierIds, List<string>? RequesterIds, List<string>? Statuses,
    ...
    // 2026-09-02 (kullanici istegi): RAPOR SIRALAMASI (sabit liste anahtari, ReportSortOptions).
    // Bos/gonderilmemis = raporun VARSAYILAN siralamasi. Bilinmeyen anahtar servis tarafinda
    // varsayilana duser (kullanici metni ASLA ORDER BY icine yazilmaz).
    string? SortKey = null,
