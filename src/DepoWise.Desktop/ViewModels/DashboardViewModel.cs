...
public sealed partial class DashboardViewModel : ViewModelBase
{
    ...
    public DashboardViewModel(SessionContext session)
    {
        try
        {
            ...
            Cards.Add(new KpiCard(s.VehicleCount.ToString(), "Toplam Araç", "accent", Primary: true));
            Cards.Add(new KpiCard(s.MaterialCount.ToString(), "Malzeme Çeşidi", "neutral", Primary: false));
            Cards.Add(new KpiCard(s.LowStockCount.ToString(), "Düşük Stok", "warning", Primary: false));
            Cards.Add(new KpiCard(s.PendingRequestCount.ToString(), "Bekleyen Talep", "neutral", Primary: false));
            Cards.Add(new KpiCard(s.PersonnelCount.ToString(), "Aktif Personel", "success", Primary: false));
...
/// <summary>Kind: accent|neutral|warning|success|danger (durum tonu). Primary: tek vurgulu kart.</summary>
public sealed record KpiCard(string Value, string Label, string Kind, bool Primary);
