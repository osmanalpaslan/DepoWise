...
ORDER BY entry_date DESC, created_at DESC LIMIT @lim;";
    ...
    // ⭐ FIN-B1 (ADR-185, Migration082 ile birlikte): iki yardımcı da FİRMA KAPSAMLI — başka firmanın
    // aynı operation_id'si bu firmanın yakıt işlemini atlatamaz / yabancı kayıt id'si döndüremez.
    // (Önizleme yolu OperationApplied zaten firma kapsamlıydı; yazma yolu artık onunla tutarlı.)
